...
export class UsersRepository {
	...
	async findUserByEmailOrId(emailOrId: string | number): Promise<User | null> {
		...
		else return await this.databaseService.user.findUnique({
			where: {
				id: emailOrId
			}
		});
	...
	async findAllUsersPaginated(skip: number, take: number, email: string | undefined) {
